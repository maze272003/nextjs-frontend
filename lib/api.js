...
const API_URL = 'https://acceptance-palmer-publish-match.trycloudflare.com/api';
...
export const getImageUrl = (imagePath) => {
  return `https://acceptance-palmer-publish-match.trycloudflare.com/storage/${imagePath}`;
};