...
const API_URL = 'https://laranext.hostcluster.site/api';
...
export const createProduct = (formData) => {
  // REMOVE the manual Content-Type header here. 
  // Let the browser/Axios set it automatically with the correct boundary.
...
export const getImageUrl = (imagePath) => {
  return `https://laranext.hostcluster.site/storage/${imagePath}`;
};
